...
<div class="loading js-loading">
    <div class="loading__img">
        <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/logo.svg" alt="ロゴ" loading="lazy" />
    </div>
</div>
<!-- メインビューのセクション -->
<div class="mv">
    <div class="mv__inner mv__scroll-inner">
        <div class="mv__scroll-track">
            <div class="mv__scroll-row mv__scroll-row--row1">
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/hand1.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/soccer.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/baseball.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/hand1.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/soccer.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/baseball.jpg" alt="スライド画像" />
            </div>
            <div class="mv__scroll-row mv__scroll-row--row2">
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/pinpon2.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/mv01.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/mv01.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/pinpon2.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/mv01.jpg" alt="スライド画像" />
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/mv01.jpg" alt="スライド画像" />
        ...
        <div class="mv__title">
            <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/main.png" alt="メンビューのアイコン" />
        </div>
    </div>
</div>
        ...
        <ul class="about__list fade-in js-fadeIn">
            <li class="about__item">
                <div class="about__item-img">
                    <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/family.jpg"
            ...
            <li class="about__item">
                <div class="about__item-img">
                    <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/run.jpg" alt="健康アイコン"
                        class="about__icon" />
                </div>
            ...
            <li class="about__item">
                <div class="about__item-img">
                    <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/frend.jpg" alt="コミュニティアイコン"
                        class="about__icon" />
                </div>
        ...
        <ul class="works__list works-list">
            <li class="works-list__item fade-in js-fadeIn">
                <div class="works-list__item-img">
                    <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/works.jpg" alt="省略" />
                </div>
            ...
            <li class="works-list__item fade-in js-fadeIn">
                <div class="works-list__item-img">
                    <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/track.jpg" alt="省略" />
                </div>
                <div class="works-list__item-content-bg">
                    <div class="works-list__item-content">
            ...
            <li class="works-list__item fade-in js-fadeIn">
                <div class="works-list__item-img">
                    <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/foot.png" alt="省略" />
                </div>
                <div class="works-list__item-content-bg">
                    <div class="works-list__item-content">
